...
wget -O requirements.txt https://raw.githubusercontent.com/Hypersight/cyberpanel/1.8.0/requirements.txt
...
if [[ $DEV == "ON" ]] ; then
	...
	source /usr/local/CyberPanel/bin/activate
	wget -O requirements.txt https://raw.githubusercontent.com/Hypersight/cyberpanel/$BRANCH_NAME/requirements.txt
...
if [[ $SERVER_COUNTRY == "CN" ]] ; then
	...
	if [[ $DEV == "ON" ]] ; then
	git clone https://github.com/Hypersight/cyberpanel
	cd cyberpanel
